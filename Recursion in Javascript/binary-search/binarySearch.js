...
const searchForAlphabeticalIndex = (
  [stringToFindIndexForFirstLetter],
  ...
  stringToFindIndexForFirstLetter =
    stringToFindIndexForFirstLetter.toLowerCase();
  ...
  const numberToSearchForElm =
    document.getElementById("number-searching-for-id") || {};
  numberToSearchForElm.innerText += stringToFindIndexForFirstLetter;

  const arrayOfNumbersToSearchInsideElm =
    document.getElementById("searched-array-id") || {};
  arrayOfNumbersToSearchInsideElm.innerText += alphabetArray;

  const linearSearchResultsElm =
    document.getElementById("linear-search-results") || {};
  linearSearchResultsElm.innerText += linearSearchResults;

  const linearSearchPositionElm =
    document.getElementById("linear-search-position") || {};
  linearSearchPositionElm.innerText += linearSearchCharacterIndex;

  const binarySearchResultsElm =
    document.getElementById("binary-search-results") || {};
  binarySearchResultsElm.innerText += binarySearchResults;

  const binarySearchPositionElm =
    document.getElementById("binary-search-position") || {};
